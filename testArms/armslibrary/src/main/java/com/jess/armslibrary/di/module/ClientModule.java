...
////                    SPUtils instance = SPUtils.getInstance("spUtils");
////                    Request request;
////                    if (!TextUtils.isEmpty(instance.getString("access_token"))) {
////                        request = chain.request();
////                        Request.Builder requestBuilder = request.newBuilder();
////                        Headers.Builder headerBuilder = request.headers().newBuilder();
////                        headerBuilder.add("Authorization", "bearer " + instance.getString("access_token"));
